...
class PermissionPolicy
{
    ...
    {
        if($admin->hasPermissionTo('View Permission')){
            return true;
        }
        return false;
    }
    ...
    {
        if($admin->hasPermissionTo('Create Permission')){
            return true;
        }
        return false;
    }
    ...
    {
        if($admin->hasPermissionTo('Edit Permission')){
            return true;
        }
        return false;
    }
    ...
    {
        if($admin->hasPermissionTo('Delete Permission')){
            return true;
        }
        return false;
    }
